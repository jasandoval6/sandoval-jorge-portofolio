...
## Key Features
- Developed a Flutter-based mobile interface with an emphasis on usability, accessibility, and responsive layouts
- Implemented persistent local storage using SQLite to support offline access to user-generated content
- Integrated the IGDB API to retrieve live game metadata, including titles, genres, and release information
- Designed intuitive navigation flows to support reviewing, rating, and favoriting games
- Structured application state to ensure smooth UI updates and consistent user interactions
